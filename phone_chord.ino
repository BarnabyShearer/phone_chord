...
#define MODEL "Phone Chord v0.0.1"
#define GRACE (20) //ms
#define CONTRY (32) //UK
...
uint8_t pins[]    = { A0, A1, A2, A3, A4, A5, 16, 15, 7, 11};
...
void setup()
{
  ...
  NRF_TIMER1->PRESCALER = 9; //32us
  NRF_TIMER2->CC[0] = 31 * GRACE;
  attachInterrupt(TIMER1_IRQn, timer, CHANGE);
}
